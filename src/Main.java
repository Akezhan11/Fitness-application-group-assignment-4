            ...
            switch (choicee) {
                case 1:{
                    while (true) {
                        ...
                        System.out.println("2: Book fitness class");
                        System.out.println("3: Cancel booking");
                        System.out.println("4: Show my bookings");
                        System.out.println("5: Mark visit (today)");
                        System.out.println("6: Show my attendance history");
                        System.out.println("7: Check my membership");
                        System.out.println("8: Update my personal data");
                        System.out.println("9: Show my personal data");
                        ...
                        switch (mChoice) {
                            ...
                            case 1 -> {
                                ...
                                if (classes.isEmpty()) System.out.println("No fitness classes.");
                                else classes.forEach(System.out::println);
                            }

                            case 2 -> {
                                System.out.print("Your Member ID: ");
                                ...
                                try {
                                    ...
                                    FitnessClass fc = fitnessService.findById(classId);

                                    membershipService.checkActive(memberId);
                                    bookingService.bookClass(member, fc);

                                    System.out.println(" Booking successful for '" + fc.getFitnessType() + "'");
                                    ...
                                    System.out.println(" You already booked this class.");
                            ...
                            case 3 -> {
                                ...
                                try {
                                    ...
                                    System.out.println(" Booking cancelled for '" + fc.getFitnessType() + "'");
                                } catch (RuntimeException e) {
                            ...
                            case 4 -> {
                                ...
                                try {
                                    bookingService.getBookingsByMember(memberId).forEach(System.out::println);
                            ...
                            case 5 -> {
                                ...
                                try {
                                    membershipService.checkActive(memberId); // посещение только с активным абонементом
                                    attendanceService.markVisit(memberId, java.time.LocalDate.now());
                                    System.out.println(" Visit marked for today.");
                                } catch (MembershipExpiredException e) {
                                    System.out.println(" Membership expired/inactive, cannot mark visit.");
                            ...
                            case 6 -> {
                                ...
                                List<Attendance> history = attendanceService.history(memberId);
                                if (history.isEmpty()) System.out.println("No attendance records.");
                ...
                case 2: {
                    ...
                    while (!authenticated) {
                        ...
                        System.out.print("Enter login (or 0 to exit): ");
                        ...
                        System.out.print("Enter password (or 0 to exit): ");
